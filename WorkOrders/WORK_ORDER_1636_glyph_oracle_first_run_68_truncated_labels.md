...
**Status:** PARTIALLY IMPLEMENTED 2026-09-10 - RumorBoard (21), DeckCardPurpose (16), HeroSelect (5) cleared on wave3-capture9 (baselined 68 -> 26 matched); NightMarket (21) and BuildMenu (1) fixes are gated separately; Manage ARMY (2) needs a copy ruling ('BUILD BARRACKS' fits); EndStateWaveClear (1) is a stale capture fixture (was: READY TO IMPLEMENT)
