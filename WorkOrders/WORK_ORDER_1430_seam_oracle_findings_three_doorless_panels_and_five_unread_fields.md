...
**Status:** CLOSED 2026-09-17 - owner felt-test PASS (validated 2026-09-17T18:20:12, build 2026.09.17.373943). PRIOR STATUS: FIXED 2026-09-10 - fields 3-5 DROPPED on the owner's ruling (levelCurve from both echoes-balance twins + EchoBalanceCatalog; visibilityRule + expiry_behavior DTO members); AuthoredFieldReaderRegression case E pins their absence; fields 1-2 landed 4f2698b86; owner felt-test closes (was: IMPLEMENTED - awaiting gate (lane FIELDS-DROP 2026-09-10). Fields 3-5 DROPPED per the 2026-09-10 owner ruling: `levelCurve` removed from both `echoes-balance.json` twins + its DTO member, `visibilityRule` + `expiry_behavior` removed as DTO members, all nine regression rows retired, and a new `AuthoredFieldReaderRegression` case `[retired-field-stays-retired]` now REDS if any of the three comes back. All five Group B fields are now resolved (2 wired `4f2698b86`, 3 dropped), and Group A resolved in `bb51b8b9c`. See the RESULT file's 2026-09-10 section. PRIOR STATUS: READY TO IMPLEMENT - fields 3-5 RULED 2026-09-10 DROP; before that, IMPLEMENTED (Group B: 2 of 5 wired) - awaiting gate (2026-09-09 lane FIELDS).)
