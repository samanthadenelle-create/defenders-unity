...
**Status:** CLOSED 2026-09-10 - owner felt-test PASS (validated 2026-09-11T01:13:20, build 2026.09.10.364108). PRIOR STATUS: FIXED 2026-09-10 - gated (wave2-compile3, wave2-reg3 493/493) and captured (Builds/wave2-capture2 -> UI_GEOMETRY_OK 91): the footer caption renders complete on one line with no ellipsis marker at 2670x1200 (PNG read by the lead); owner felt-test closes. (was: IMPLEMENTED - awaiting gate (lane FOOTER-FONT 2026-09-10))
