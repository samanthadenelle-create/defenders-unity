...
**Status:** IN PROGRESS - current checkpoint covers localization authority, regional parity, six-locale beta, and calm/Heart/Flee HUD copy; Store and remaining visible-text batches are still open
...
- exact reconciliation of six build-enabled Unity tables to 375 canonical keys each, including
...
Evidence: the latest canonical import reports 2,250 localized entries across six enabled tables;
the focused suite reports `LOCALIZATION_REGRESSION_OK 7/7 suites`, and the full registered
...
The clean staged-tree manifest contains 5,992 report rows (375 keyed entries, 83 keyed wrapper
