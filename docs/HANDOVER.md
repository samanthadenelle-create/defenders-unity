...
> `catalog_2026.09.09.362346`, `R2_PARITY_OK 276`, `adb install Success`.
> Carries: garrison **defend posts** (gate/yard/keep hold; wake on hero OR troops),
> filled gate mouth, grey-card VFX mesh suppress, quiet raid HUD. Hero-death still
> fights on at 2 stars (WO-1526) until the owner rules otherwise. Not committed.

> **2026-09-09 RAID BASE DESIGN:** Owner asked to review the live raid bases and design them
> as places — KayKit dungeon welcome, defenses beyond fence + tower. **WO-1607–1611**
> (spine 1607; engine 1608; Easy 1609; Hard 1610; Extreme 1611). IMPLEMENTED in tree and
> baked once; PO felt-test closes. Do not retune garrison HP. Village2 and Iron Bastion
> are out of scope.
